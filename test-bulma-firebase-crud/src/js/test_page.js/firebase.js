...
function getWidgetUrl() {
  return '/firebase_auth_widget.html#recaptcha=normal&emailSignInMethod=emailLink';
}
...
document.querySelector("#sign-in-with-popup").addEventListener("click", signInWithPopup);
